" Name:         Pumpkinspice Hard
" Description:  silly fall-based theme based on gruvbox 
" Author:       jdonaldson <jdonaldson@gmail.com> 
" Maintainer:   jdonaldson <jdonaldson@gmail.com> 
" Website:      https://github.com/jdonaldson/vim-pumpkinspice/
" License:      Vim License (see `:help license`)
" Last Updated: Tue Oct  5 14:23:47 2021

" Generated by Colortemplate v2.1.0

hi clear
let g:colors_name = 'pumpkinspice_hard'

let s:t_Co = exists('&t_Co') && !empty(&t_Co) && &t_Co > 1 ? &t_Co : 2
let s:italics = (&t_ZH != '' && &t_ZH != '[7m') || has('gui_running') || has('nvim')

let s:italics = s:italics && get(g:, 'pumpkinspice_italics', 1)
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#1d2021', '#cc241d', '#64641a', '#c89921', '#458588', '#fa3232', '#689d6a', '#a89984', '#928374', '#fb4934', '#b8bb26', '#fabd2f', '#83a598', '#d3869b', '#8ec07c', '#ebdbb2']
    if has('nvim')
      let g:terminal_color_0 = '#1d2021'
      let g:terminal_color_1 = '#cc241d'
      let g:terminal_color_2 = '#64641a'
      let g:terminal_color_3 = '#c89921'
      let g:terminal_color_4 = '#458588'
      let g:terminal_color_5 = '#fa3232'
    ...
    if get(g:, 'pumpkinspice_transp_bg', 0) && !has('gui_running')
    ...
    if !get(g:, 'pumpkinspice_italicize_strings', 1)
      hi Special gui=NONE cterm=NONE
      hi String gui=NONE cterm=NONE
    endif
    if !get(g:, 'pumpkinspice_bold', 1)
    ...
    if !(get(g:, 'pumpkinspice_plugin_hi_groups', 0) || get(g:, 'pumpkinspice_filetype_hi_groups', 0))
      finish
    endif
    if get(g:, "pumpkinspice_plugin_hi_groups", 0)
      ...
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g:, 'pumpkinspice_invert_indent_guides', 0)
      ...
      if !exists('g:rbpt_colorpairs')
        let g:rbpt_colorpairs = [['blue', '#458588'], ['magenta', '#fa3232'],
              \ ['red', '#cc241d'], ['166', '#d65d0e']]
      endif

      let g:rainbow_guifgs = [ '#d65d0e', '#cc241d', '#fa3232', '#458588' ]
    ...
    if get(g:, "pumpkinspice_filetype_hi_groups", 0)
  ...
  " Light background
  let g:terminal_ansi_colors = ['#3c3836', '#cc241d', '#64641a', '#c89921', '#458588', '#fa3232', '#689d6a', '#7c6f64', '#928374', '#9d0006', '#79740e', '#b57614', '#076678', '#8f3f71', '#427b58', '#f9f5d7']
  if has('nvim')
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'pumpkinspice_transp_bg', 0)
...
" Color: neutralgreen      rgb(100, 100,  26)    100 DarkGreen
" Color: neutralyellow     rgb(200, 153,  33)    172 DarkYellow
" Color: neutralblue       rgb( 69, 133, 136)    66  DarkBlue
" Color: neutralpurple     rgb(250, 50, 50)    132 DarkMagenta
